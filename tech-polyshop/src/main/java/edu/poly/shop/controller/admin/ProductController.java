...
public class ProductController {
	...
	// hiển thị danh sách các category cho phép nguwoif dùng chọn danh mục sản phẩm
...
// dọc dữ liệu và hiển thị trên bảng
	@RequestMapping("")
...
// validateform, search, phan trang delete,pase size